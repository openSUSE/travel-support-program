...
describe 'Assistant' do
  ...
  context 'when managing their own requests' do
    ...
    it { is_expected.to be_able_to(:read, requests(:assistant_for_party)) }
    it { is_expected.to be_able_to(:read, requests(:assistant_for_yavin)) }
    it { is_expected.to be_able_to(:update, requests(:assistant_for_party)) }
    it { is_expected.not_to be_able_to(:update, requests(:assistant_for_yavin)) }
    it { is_expected.to be_able_to(:destroy, requests(:assistant_for_party)) }
    it { is_expected.not_to be_able_to(:destroy, requests(:assistant_for_yavin)) }
    it { is_expected.to be_able_to(:cancel, requests(:assistant_for_party)) }
    it { is_expected.to be_able_to(:cancel, requests(:assistant_for_yavin)) }
    it { is_expected.not_to be_able_to(:adjust_state, requests(:assistant_for_yavin)) }
    it { is_expected.not_to be_able_to(:adjust_state, requests(:assistant_for_party)) }
  end
  ...
  context 'when asking for reimbursement' do
    it { is_expected.to be_able_to(:create, requests(:assistant_for_yavin).build_reimbursement) }
  ...
  context 'when managing their own reimbursement' do
    let(:reimbursement) { requests(:assistant_for_yavin).create_reimbursement }
    ...
    before do
      ...
      reimbursement.create_bank_account(holder: 'Assistant', bank_name: 'Bank',
  ...
  context 'when managing attachments to their own reimbursements' do
    let(:reimbursement) { reimbursements(:assistant_for_training_reim) }
    ...
    context 'when submitting it' do
      before do
        transition(reimbursement, :submit, users(:assistant))
      end
  ...
  context 'when managing their own shipments' do
    ...
    it { is_expected.to be_able_to(:read, requests(:assistant_costumes_for_party)) }
    it { is_expected.to be_able_to(:update, requests(:assistant_costumes_for_party)) }
    it { is_expected.to be_able_to(:destroy, requests(:assistant_costumes_for_party)) }
    it { is_expected.to be_able_to(:cancel, requests(:assistant_costumes_for_party)) }
    it { is_expected.not_to be_able_to(:adjust_state, requests(:assistant_costumes_for_party)) }
  end
