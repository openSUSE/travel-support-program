...
feature "Menu", "" do
  ...
  scenario "as requester" do
    ...
    find("#options").should have_link "Travel support requests", :href => requests_path
  ...
  scenario "as tsp member" do
    ...
    find("#options").should have_link "Travel support requests", :href => requests_path(:q => {:state_in => %w(submitted)})
